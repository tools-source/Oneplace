    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("Purchase Error", isPresented: purchaseErrorBinding) {
                ...
                Text(purchaseManager.purchaseErrorMessage ?? "Please try again.")
            }
        }
    }
    ...
    private var adsSection: some View {
        Section("Ads") {
            HStack {
                Text("Status")
                Spacer()
                Text(purchaseManager.isAdsRemoved ? "Removed" : "Enabled")
                    .foregroundStyle(purchaseManager.isAdsRemoved ? DesignSystem.gainColor : .secondary)
            }
            .listRowBackground(Color.clear)

            if purchaseManager.isAdsRemoved {
                Label("Ads are removed on this device.", systemImage: "checkmark.circle.fill")
                    .font(.footnote)
                    .foregroundStyle(DesignSystem.gainColor)
                    .listRowBackground(Color.clear)
            } else {
                Button {
                    Task {
                    ...
                    HStack {
                        Label("Remove Ads", systemImage: "nosign")
                            .foregroundStyle(DesignSystem.primaryTextColor)
                        Spacer()
                        if purchaseManager.isPurchasing {
                            ...
                            Text(purchaseManager.removeAdsPriceText)
